...
///
/// ```rust
/// use swe_edge_loadbalancer_egress::ApplicationConfigBuilder;
///
...
impl ApplicationConfigBuilder {
    ...
    pub fn with_toml(mut self, toml: impl Into<String>) -> Result<LoadbalancerConfig, EgressError> {
    ...
    /// # Errors
    ///
    /// Returns `EgressError::ParseFailed` if the TOML is malformed.
    pub fn build(self) -> Result<LoadbalancerConfig, EgressError> {
